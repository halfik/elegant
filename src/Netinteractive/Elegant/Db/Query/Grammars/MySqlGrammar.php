...
namespace Netinteractive\Elegant\Db\Query\Grammars;

use Illuminate\Support\Str;
use  Netinteractive\Elegant\Db\Query\Builder;
use  Netinteractive\Elegant\Db\Query\JsonExpression;

/**
 * Class MySqlGrammar
 * @package Netinteractive\Elegant\Db\Query\Grammars
 */
class MySqlGrammar extends Grammar
{
     ...
     *
     * @param  string  $key
     * @param  \Netinteractive\Elegant\Db\Query\JsonExpression  $value
     * @return string
     */
