   ...
   protected function init()
    {
        ...
        $this->getRelationManager()->hasMany('PatientData', 'med__id', 'id');
        $this->getRelationManager()->belongsToMany('Patient', 'patient_data', 'med__id', 'patient__id');
        $this->getRelationManager()->hasMany('User', 'med_id', 'id');
