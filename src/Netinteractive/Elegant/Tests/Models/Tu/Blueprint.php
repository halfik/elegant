   ...
   protected function init()
    {
        ...
        $this->getRelationManager()->hasMany('PatientData', 'tu__id', 'id');
        $this->getRelationManager()->belongsToMany('Patient', 'patient_data', 'tu__id', 'patient__id');
        $this->getRelationManager()->hasMany('User', 'tu__id', 'id');
